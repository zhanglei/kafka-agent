...
public class KafkaToKuduSpecialExtractApp {
	...
	private static final String PROP_PREFIX = "kafka-to-kudu-spe";

	private static String agentSvrName = PropsUtil.getWithDefault(PROP_PREFIX, "agentSvrName", "KafkaToKuduSpecial");
	private static String agentSvrGroup = PropsUtil.getWithDefault(PROP_PREFIX, "agentSvrGroup", "KafkaToKuduSpecialGroup");
	...
	private static String kafkaGroupId = PropsUtil.getWithDefault(PROP_PREFIX, "kafkaGroupId", "ConsumerToKuduSpecialApp");
